# Goobi workflow Plugin: goobi-plugin-metadata-change-type

<img src="https://goobi.io/wp-content/uploads/logo_goobi_plugin.png" align="right" style="margin:0 0 20px 20px;" alt="Plugin for Goobi workflow" width="175" height="109">

This Metadata plugin for Goobi workflow allows to change the METS structure based by a user selecting between available templates. It was developed for the use cases of the Prizepapers project.
